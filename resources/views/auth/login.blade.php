...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="{{ asset('backend/images/Logo_school.png') }}">
	...
	<div class="container h-p100">
				...
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
						<div class="content-top-agile p-10">
							<h2 class="text-white">School Management</h2>
							<p class="text-white-50">Welcome to login</p>							
						</div>
        ...
        @csrf
                ...
                <div class="form-group">
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-transparent text-white"><i class="fa fa-user-circle-o"></i></span>
                        </div>
                ...
                <div class="form-group">
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text  bg-transparent text-white"><i class="ion ion-locked"></i></span>
                        </div>
