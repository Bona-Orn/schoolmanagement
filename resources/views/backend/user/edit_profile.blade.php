		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title"><i class="glyphicon glyphicon-user"></i> Manage Profile</h4>
					  ...
					  <div class="row">
						...
						<div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        <img id="showImage" src="{{ (!empty($user->image))? url('upload/user_images/'.$user->image):url('upload/photo.jpg') }}" width="200" height="200" alt=""> 
                                    </div>
                                </div>
